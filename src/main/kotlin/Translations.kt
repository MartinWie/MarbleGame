        ...
        mapOf(
            "en" to
                mapOf(
                    ...
                    // Home page
                    "home.createGame" to "Create Marbles Game",
                    "home.createGameHint" to "Play the original marbles game.",
                    "home.createChess" to "Create Chess Game",
                    "home.createChessHint" to "2 players can play, everyone else spectates.",
                    "home.chooseMode" to "Choose Your Game",
                    "home.chooseModeHint" to "Pick a mode, then create your room.",
            ...
            "de" to
                mapOf(
                    ...
                    // Home page
                    "home.createGame" to "Murmelspiel erstellen",
                    "home.createGameHint" to "Spiele das klassische Murmelspiel.",
                    "home.createChess" to "Schachspiel erstellen",
                    "home.createChessHint" to "2 Spieler spielen, alle weiteren schauen zu.",
                    "home.chooseMode" to "Spielmodus wahlen",
                    "home.chooseModeHint" to "Wahle einen Modus und erstelle dann deinen Raum.",
                    ...
                    "button.createChess" to "Schach erstellen",
                    ...
                    "chess.select.from" to "Figur wahlen",
                    "chess.select.to" to "Zielfeld wahlen",
